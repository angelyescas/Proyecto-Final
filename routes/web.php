...
Route::get('suscripcion', 'SuscripcionController@index')->name('suscripcion.index');
Route::get('suscripcion/getdata', 'SuscripcionController@getdata')->name('suscripcion.getdata');
